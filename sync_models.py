...
class InfraCircuit(InfrahubModel):
    ...
    _attributes = ("tags", "type", "status", "provider", "description", "vendor_id")
    description: str | None = None
...
class InfraDevice(InfrahubModel):
    ...
    _attributes = ("model", "platform", "status", "tags", "role", "rack", "serial_number", "asset_tag")
...
class InfraInterfaceL2L3(InfrahubModel):
    ...
    _identifiers = ("name", "device")
    _attributes = ("ip_addresses", "tagged_vlan", "status", "tags", "l2_mode", "description", "mgmt_only", "mac_address", "interface_type")
...
class InfraProviderNetwork(InfrahubModel):
    ...
    _identifiers = ("name",)
    _attributes = ("tags", "provider", "status", "vendor_id", "description")
    vendor_id: str | None = None
    description: str | None = None
    name: str
    tags: list[str] | None = []
...
class InfraRack(InfrahubModel):
    ...
    _identifiers = ("name",)
    _attributes = ("role", "tags", "location", "serial_number", "facility_id", "height", "asset_tag")
    serial_number: str | None = None
...
class InfraVLAN(InfrahubModel):
    ...
    _identifiers = ("name",)
    _attributes = ("status", "organization", "role", "locations", "vlan_group", "description", "vlan_id")
    description: str | None = None
    name: str
    vlan_id: int
    status: str | None = None
